...
export const UserSidebar = () => {
  ...
  return (
    <>
      ...
      {isuserOpen && (
        <div className="fixed top-10 right-1 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
