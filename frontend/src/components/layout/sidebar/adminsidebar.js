            ...
            <li>
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-500 dark:group-hover:text-white"
                  viewBox="0 0 448 512"
                >
            ...
            <li>
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  class="flex-shrink-0 w-6 h-6  dark:hover:bg-gray-700 text-gray-200 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  viewBox="0 0 448 512"
                >
