            ...
            <div class="w-full md:w-1/3 xl:w-1/2 flex items-center justify-center mt-6 md:mt-0">
              <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md border-2 border-gray-400 w-full max-w-md">
                ...
                <div class="flex flex-row mt-5">
                  {!logintype && (
                    <button
                      class="mr-2 relative w-full border rounded-md py-2 text-sm text-gray-800 bg-gray-200 hover:bg-gray-300"
                  ...
                  {logintype && (
                    <button class="mr-2 relative w-full border rounded-md py-2 text-sm font-bold text-white bg-blue-500">
                  ...
                  {logintype && (
                    <button
                      class=" relative w-full  border rounded-md py-2 text-sm text-gray-800 bg-gray-200 hover:bg-gray-300"
                  ...
                  {!logintype && (
                    <button
                      class=" relative w-full  border rounded-md py-2 text-sm font-bold text-white bg-blue-500"
                    >
                      <span class="absolute left-0 top-0 flex items-center justify-center h-full w-10 text-white ">
                        <i class="fas fa-user-md"></i>
                      </span>
