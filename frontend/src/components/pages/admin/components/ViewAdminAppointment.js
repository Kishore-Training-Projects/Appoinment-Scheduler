                ...
                <div class="w-full h-full bg-white p-3 shadow-sm rounded-sm">
                  ...
                  <div class="text-gray-700 mt-2">
                    ...
                    <div className="flex items-end justify-end">
                        ...
                        {appointmentdata.medicalrecordStatus == false && appointmentdata.appointmentStatus !="canceled" &&(
                            
                            <AddAdminMedicalrecord id = {appointmentdata.appointmentId}/>
                        )}
                      ...
                      <button className=" mx-2 text-xs bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded">
                        ...
                        {appointmentdata.appointmentStatus !="canceled" &&(
                            ...
                            <CancelAdminAppointment id = {appointmentdata.appointmentId} fetch_appointment_data={fetch_appointment_data} />
                        )}
