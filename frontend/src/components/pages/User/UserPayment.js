  ...
  const tableData = [
    {
        ...
        payment: 150.00,
        paymentDateTime: '2023-06-28 10:30 AM',
      ...
      },
      {
        paymentMode: 'Cash',
        payment: 75.00,
        paymentDateTime: '2023-06-27 02:15 PM',
        transactionId: 'DEF456XYZ',
        paymentStatus: 'Success',
      },
      {
        paymentMode: 'Online Transfer',
        payment: 200.00,
        paymentDateTime: '2023-06-26 11:45 AM',
        transactionId: 'GHI789XYZ',
        paymentStatus: 'Success',
      },
      {
        paymentMode: 'Debit Card',
        payment: 120.00,
        paymentDateTime: '2023-06-25 09:00 AM',
        transactionId: 'JKL012XYZ',
        paymentStatus: 'Failed',
      },
      {
        paymentMode: 'Cheque',
        payment: 180.00,
        paymentDateTime: '2023-06-24 03:30 PM',
        transactionId: 'MNO345XYZ',
        paymentStatus: 'Success',
      },
      {
        paymentMode: 'Mobile Wallet',
        payment: 100.00,
        paymentDateTime: '2023-06-23 12:00 PM',
        transactionId: 'PQR678XYZ',
        paymentStatus: 'Success',
      },
      {
        paymentMode: 'Bank Transfer',
        payment: 250.00,
        paymentDateTime: '2023-06-22 08:45 AM',
        transactionId: 'STU901XYZ',
        paymentStatus: 'Success',
      },
      {
        paymentMode: 'Credit Card',
        payment: 80.00,
        paymentDateTime: '2023-06-21 05:15 PM',
        transactionId: 'VWX234XYZ',
        paymentStatus: 'Failed',
      },
  ];
                      ...
                      <tbody>
                        {currentPageData.map((row, index) => (
                          ...
                          >
                            ...
                            <td class="px-4 py-3 ">{row.paymentDateTime}</td>
                            <td class="px-4 py-3 ">{row.transactionId}</td>

                            <td class="px-4 py-3 text-center">{row.paymentStatus}</td>
